...
// ---- Common Options ----
var gMonths=["JAN","FEB","MAR","APR","MAJ","JŪN","JŪL","AUG","SEP","OKT","NOV","DEC"];
var gWeekDay=["Sv","P","O","T","C","P","S"];	// weekday caption from Sunday to Saturday
...
var gsOutOfRange="Jūs nedrīkstat iziet ārpus pieaujam datuma apgabala!";	// out-of-date-range error message. If set to "", no alerts will popup on such error.
...
var gcCalBG="#edf2f5";	// the background color of the outer calendar panel.
var guCalBG=null;	//  the background image url for the inner table.
var gcCalFrame="#edf2f5";	// the background color of the inner table, showing as a frame.
var gsInnerTable="border=0 cellpadding=1 cellspacing=0 class=\"pop-cal-in\"";	//  HTML tag properties of the inner <table> tag, which holds all the calendar cells.
var gsOuterTable=NN4?"border=0 cellpadding=3 cellspacing=0 class=\"pop-cal-out\"":"border=0 cellpadding=0 cellspacing=1";	// HTML tag properties of the outmost container <table> tag, which holds the top, middle and bottom sections.
...
var gsNavPrev="<IMG class='MonthNav' src='arrowl.gif' width='18' height='18' border='0' alt='' onmousedown='showPrevMon()' onmouseup='stopShowMon()' onmouseout='stopShowMon();if(this.blur)this.blur()'>";	// the content of the left month navigator
var gsNavNext="<IMG class='MonthNav' src='arrowr.gif' width='18' height='18' border='0' alt='' onmousedown='showNextMon()' onmouseup='stopShowMon()' onmouseout='stopShowMon();if(this.blur)this.blur()'>";	// the content of the right month navigator

var gbHideBottom=false;	// true: hide the bottom section; false: show it with gsBottom.
var gsBottom=(NN4?"":"<DIV class='BottomDiv'>")+"<A class='Today' href='javascript:void(0)' onclick='if(this.blur)this.blur();fClearSelected();return false;' onmouseover='return true;' title='Notīram atzīmtās vērtības.'>Notīrīt</A>"+(NN4?"":"&nbsp;<A class='Today' href='javascript:void(0)' onclick='fHideCal();' title='Aizvērt kalendru'>Aizvērt</a>&nbsp;<a href='javascript:void(0)' class='Today' onclick='fSetCal(gd.getFullYear(),gd.getMonth()+1,gd.getDate(),true,event)'>Šodiena</a></div>");	// the content of the bottom section.
...
var gcCellBG="#edf2f5";	// default background color of the cells. Use "" for transparent!!!
...
var gcWorkday="#0000CC";	// Workday font color
var gcSat="#0000CC";	// Saturday font color
var gcSatBG="#b5cbd7";	// Saturday background color
var gcSun="#0000CC";	// Sunday font color
var gcSunBG="#b5cbd7";	// Sunday background color
...
var gcToggle="#f2e0e0";	// the highlight color for the focused cell

var gcFGToday="#f2e0e0";	// the font color for today 
var gcBGToday="#ed1c24";	// the background color for today 
...
var gcFGSelected="#f2e0e0";	// the font color for the selected date
...
var gdSelect=[gd.getFullYear(),gd.getMonth()+1,gd.getDate()];	// default selected date in format of [year, month, day]; [0,0,0] means no default date selected.
//var gads=gd.getFullYear();
	//var men=gd.getMonth()+1;
	//var dat=gd.getDate();
	//dat+"."+men+"."+gads
