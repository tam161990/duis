...
<table cellpadding="3" cellspacing="1" border="0" width="100%" >
   ...
   <tr>
		...
		<td class="table_cell_2" width="25%"><?= $oForm -> getElementHtml('edRegion'); ?></td>
   ...
   <tr>
        ...
        <td class="table_cell_c"  width="10%"><?= $oForm -> getElementLabel('contract'); ?>:</td>
		<td class="table_cell_2" width="25%"><?= $oForm -> getElementHtml('contract'); ?></td>
   	</tr>
