...
<body class="frame_2">
    ...
    <h1><?=text::toUpper(text::toUpper(text::get('WRITE_OFF_CODES_INFO')));?></h1>
    <?= $oForm -> getFormHeader(); ?>
    <table cellpadding="5" cellspacing="1" border="0" width="100%">
        ...
        <tr>
            <td class="table_cell_c" width="16%"><?= $oForm -> getElementLabel('kalculk_kods'); ?>:<font color="red">*</font></td>
            <td class="table_cell_2" width="16%"><?= $oForm -> getElementHtml('kalculk_kods'); ?></td>        
            <td class="table_cell_c" width="16%"><?= $oForm -> getElementLabel('kalk_nosaukums'); ?>:<font color="red">*</font></td>
            <td class="table_cell_2" colspan="3"><?= $oForm -> getElementHtml('kalk_nosaukums'); ?></td>
        </tr>
        <tr>
