...
<table cellpadding="5" cellspacing="1" border="0" width="100%">
    ...
    <tr>
		...
		<td class="table_cell_2" width="24%"><?= $oForm -> getElementHtml('mmsWork'); ?></td>
  ...
  <?  if(true)  {?>
    ...
    <tr>
     ...
     <? if($actId != false && $trase == 1 && $isPlan)  {?>
     <br />
   <table cellpadding="5" cellspacing="1" border="0" width="100%">
    <tr>
		<td width="16%" class="table_cell_c"><?= $oForm -> getElementLabel('koknese'); ?>:</td>
		<td  width="24%" class="table_cell_2"><?= $oForm -> getElementHtml('koknese'); ?></td>
        <td width="16%" class="table_cell_c"><?= $oForm -> getElementLabel('plpayment'); ?>:</td>
		<td  width="24%" class="table_cell_2"><?= $oForm -> getElementHtml('plpayment'); ?></td>
        <td width="20%">&nbsp;</td>
   	</tr>
    </table>
     <? } ?>
