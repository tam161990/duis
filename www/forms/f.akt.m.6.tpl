...
<table cellpadding="3" cellspacing="1" border="0" width="100%" >
   ...
   <tr>
		...
		<td class="table_cell_2" width="20%"><?= $oForm -> getElementHtml('year'); ?></td>
        <td class="table_cell_c" width="10%"><?= $oForm -> getElementLabel('edRegion'); ?>:</td>
		<td class="table_cell_2" width="20%"><?= $oForm -> getElementHtml('edRegion'); ?></td>
        <td class="table_cell_c" rowspan="4" width="10%"><?= $oForm -> getElementLabel('status'); ?>:</td>
		<td class="table_cell_2" rowspan="4" width="20%"><?= $oForm -> getElementHtml('status'); ?></td>
   </tr>
   <tr>
    ...
    <tr>
		...
		<td class="table_cell_2"><?= $oForm -> getElementHtml('object'); ?></td>
         <td class="table_cell_c"><?= $oForm -> getElementLabel('ouner'); ?>:</td>
		<td class="table_cell_2"><?= $oForm -> getElementHtml('ouner'); ?></td>
