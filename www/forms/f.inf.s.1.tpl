	...
	<table cellpadding="0" cellspacing="0" border="0">
		<tr>
           ...
           <td class="menu_cell"><a  target="frame_1" href="<?=$calculationListLink;?>" onclick="reloadFrame(2,'<?=$editCalculationLink;?>');reloadFrame(3,'');enableFrameControl();window.top.normal();hideMenu();"><?=text::get('CALCULATION');?></a></td>
             <td class="menu_cell"><a  target="frame_1" href="<?=$calculationTrListLink;?>" onclick="reloadFrame(2,'<?=$editCalculationTrLink;?>');reloadFrame(3,'');enableFrameControl();window.top.normal();hideMenu();"><?=text::get('TRASE_KALCULATION');?></a></td>
