...
if($isAdmin || $isEdUser || $isAuditor )
{
	...
	<table cellpadding="0" cellspacing="0" border="0">
		<tr>
		   ...
		   <td class="menu_cell" nowrap><a  target="frame_1" href="<?=$materialListLink;?>" onclick="reloadFrame(2,'<?=$editMaterialLink;?>');reloadFrame(3,'');enableFrameControl();window.top.normal();hideMenu();"><?=text::get('MATERIALS');?></a></td>
           <td class="menu_cell" nowrap><a  target="frame_1" href="<?=$regionListLink;?>" onclick="reloadFrame(2,'<?=$editRegionLink;?>');reloadFrame(3,'');enableFrameControl();window.top.normal();hideMenu();"><?=text::get('REGIONS');?></a></td> 
           <td class="menu_cell" nowrap><a  target="frame_1" href="<?=$edAreaListLink;?>" onclick="reloadFrame(2,'<?=$editEdAreaLink;?>');reloadFrame(3,'');enableFrameControl();window.top.normal();hideMenu();"><?=text::get('ED_AREA');?></a></td>
           <td class="menu_cell" nowrap><a  target="frame_1" href="<?=$voltageListLink;?>" onclick="reloadFrame(2,'<?=$editVoltageLink;?>');reloadFrame(3,'');enableFrameControl();window.top.normal();hideMenu();"><?=text::get('VOLTAGE');?></a></td>
           <td class="menu_cell" nowrap><a  target="frame_1" href="<?=$objectListLink;?>" onclick="reloadFrame(2,'<?=$editObjectLink;?>');reloadFrame(3,'');enableFrameControl();window.top.normal();hideMenu();"><?=text::get('OBJECTS');?></a></td>
           <td class="menu_cell" nowrap><a  target="frame_1" href="<?=$dUListLink;?>" onclick="reloadFrame(2,'<?=$editDULink;?>');reloadFrame(3,'');enableFrameControl();window.top.normal();hideMenu();"><?=text::get('WORK_OUNERS');?></a></td>
           <td class="menu_cell" nowrap><a  target="frame_1" href="<?=$calculationGroupListLink;?>" onclick="reloadFrame(2,'<?=$editCalculationGroupLink;?>');reloadFrame(3,'');enableFrameControl();window.top.normal();hideMenu();"><?=text::get('CALCULATION_GROUP');?></a></td>
           <td class="menu_cell" nowrap><a  target="frame_1" href="<?=$calculationListLink;?>" onclick="reloadFrame(2,'<?=$editCalculationLink;?>');reloadFrame(3,'');enableFrameControl();window.top.normal();hideMenu();"><?=text::get('CALCULATION');?></a></td>
             <td class="menu_cell" nowrap><a  target="frame_1" href="<?=$calculationTrListLink;?>" onclick="reloadFrame(2,'<?=$editCalculationTrLink;?>');reloadFrame(3,'');enableFrameControl();window.top.normal();hideMenu();"><?=text::get('TRASE_KALCULATION');?></a></td>
           <td class="menu_cell" nowrap><a  target="frame_1" href="<?=$actTypeListLink;?>" onclick="reloadFrame(2,'<?=$editActTypeLink;?>');reloadFrame(3,'');enableFrameControl();window.top.normal();hideMenu();"><?=text::get('ACT_TYPE');?></a></td>
           <td class="menu_cell" nowrap><a  target="frame_1" href="<?=$userListLink;?>" onclick="reloadFrame(2,'<?=$editUserLink;?>');reloadFrame(3,'');enableFrameControl();window.top.normal();hideMenu();"><?=text::get('USERS');?></a></td>
            <td class="menu_cell" nowrap><a  target="frame_1" href="<?=$userDUListLink;?>" onclick="reloadFrame(2,'<?=$editDUUserLink;?>');reloadFrame(3,'');enableFrameControl();window.top.normal();hideMenu();"><?=text::get('USERS_DU');?></a></td>
           <td class="menu_cell" nowrap><a  target="frame_1" href="<?=$harmonizedListLink;?>" onclick="reloadFrame(2,'<?=$editHarmonizedLink;?>');reloadFrame(3,'');enableFrameControl();window.top.normal();hideMenu();"><?=text::get('HARMONIZED');?></a></td>
           <td class="menu_cell" nowrap><a  target="frame_1" href="<?=$mmsListLink;?>" onclick="reloadFrame(2,'<?=$editMMSLink;?>');reloadFrame(3,'');enableFrameControl();window.top.normal();hideMenu();"><?=text::get('SINGLE_MMS');?></a></td>
           <?
if(!$isAuditor)
{
?>
