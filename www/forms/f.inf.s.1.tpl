...
if($isAdmin)
{
	...
	<table cellpadding="0" cellspacing="0" border="0">
		<tr>
		   ...
		   <td class="menu_cell" nowrap><a target="frame_1" href="<?=$rbfExportLink;?>" onclick="reloadFrame(23,'');disableFrameControl();window.top.min(1);hideMenu();"><?=text::get('RBF_EXPORT');?></a></td>
