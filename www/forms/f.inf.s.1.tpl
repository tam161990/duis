		...
		<td class="head_table_top">
			...
			<table cellpadding="3" cellspacing="0" border="0">
				<tr>
					...
					<td nowrap id="tdPpaReport" class="menu_cell_top" <?=($isAdmin || $isPpaUser)?'':'disabled';?>><?=($isAdmin || $isPpaUser)?'<a onclick="reloadFrame(23,\'\');disableFrameControl();window.top.min(1);hideMenu();" href="'.$cPpaReportMain.'" target="frame_1">':'';?><?=text::get('PPA');?><?=($isAdmin || $isPpaUser)?'</a>':'';?></td>
