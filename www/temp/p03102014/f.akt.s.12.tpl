...
<table cellpadding="0" cellspacing="0" class="print_table_portrait" >
  ...
  <tr>
    <td  colspan="2" class="print_header_centered" align="center"><?= text::get('TRASE_ACT_HEADER4'); ?></td>
  </tr>
  <tr>
     <td colspan="2">&nbsp;</td>
  </tr>
  <tr>
    <td><?= dtime::dateToLvString(date('d.m.Y')); ?></td>
  ...
  <tr>
     <td colspan="2"><?= text::get('SUPORT_ACT_HEADER5'); ?></td>
  </tr>
  <tr>
     <td colspan="2">&nbsp;</td>
  </tr>
...
?>
			<tr >
                ...
                <td align="center" class="print_table_data">&nbsp;<?= (($material['MATR_IS_WORKER'] == '1')? '' : $material['MATR_CENA']) ?></td>
                <td align="center" class="print_table_data">&nbsp;<?= $material['MATR_DAUDZUMS']; ?></td>
                <td align="center" class="print_table_data">&nbsp;<?= (($material['MATR_IS_WORKER'] == '1')? '' : $material['MATR_CENA_KOPA']) ?></td>
			</tr>
<?
		}
?>
